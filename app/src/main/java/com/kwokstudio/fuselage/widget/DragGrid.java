...
public class DragGrid extends GridView {
	...
	private int firstCanMoveItem=0;  //第一个可以被移动的条目，默认为全部都可以被移动
	private Vibrator mVibrator; //振动器，在构造方法被初始化
	private int mHorizontalSpacing = 15;  //item间的水平间距，默认15dp，构造方法中转化为px
	private int mVerticalSpacing = 3;   //item间的竖直间距，默认3dp，构造方法中转化为px
	private double dragScale=1.2;   //拖动时的放大倍数
	 ...
	 *
	 */
	private void setSpacing(int mHorizontalSpacing,int mVerticalSpacing){
	 ...
	 *
	 */
	private void setDragScale(double scale){
	...
	public void init(Context context){
		...
		mVerticalSpacing=dip2px(context,mVerticalSpacing);
	}
...
//		}
	...
	public void setOnItemClickListener(final MotionEvent ev) {
		setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				if (startPosition < firstCanMoveItem) {
					return false;
				}
	 ...
	 *
	 */
	private void setFirstCanMoveItem(int position) {
		firstCanMoveItem=position;
	}
